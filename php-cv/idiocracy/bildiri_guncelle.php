...
<head> 
	...
	<title>furkan ışık'nin Kişisel Web Sayfası</title> 
...
<div class="baslik" align="center">Bildiri Güncelleme</div>
...
<?php
				...
				$bilgi= mysqli_query($baglanti_an,"SELECT * FROM bildiri where makale_id  = $makale_id");
...
if(isset($_POST["kaydet_makale"]))
			{
				...
				if (SqlBaglanti())
					...
					mysqli_query(SqlBaglanti(),"UPDATE bildiri Set makale_adi='$makale_adi', yazar_adi= '$yazar_adi', dergi_adi='$dergi_adi', makale_abstract='$makale_abstract', makale_keywords='$makale_keywords' where makale_id = $makale_id"); 
					header("Refresh: 0");
					}
			}
